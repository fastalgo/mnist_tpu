...
python mnist_tpu.py --tpu=infer1 --use_tpu=True --data_dir=gs://bert-pretrain-data/mnist/ --model_dir=gs://bert-pretrain-data/mnist_log3/ --batch_size=1024 --iterations=500 --train_steps=1758 --eval_steps=10 --enable_predict=False --learning_rate=0.004 --warm_up_epochs=1
